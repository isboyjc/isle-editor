...
<script setup>
import { Heading, OrderedList, BulletList, TaskList, Blockquote, Divider, Bold, Italic, Strike, Underline, Subscript, Superscript, Code, Link } from '@isle/editor'
...
const extensions = [Heading, OrderedList, BulletList, TaskList, Blockquote, Divider, Italic, Strike, Underline, Subscript, Superscript, Bold, Code, Link]
