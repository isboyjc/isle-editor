import { Editor, Document, Text, Paragraph, Gapcursor, HardBreak, CharacterCount, History, Indent, Typography, CommandAKeymap, ListItem } from '@isle/editor'
...
export default defineComponent({
  ...
  emits: ['update:modelValue', 'update', 'beforeCreate', 'create', 'selectionUpdate', 'transaction', 'focus', 'blur', 'destroy', 'contentError', 'paste', 'drop'],
  setup(props, { slots, emit, expose }) {
    ...
    const extensions = [...coreExtensions, ...props.extensions].filter(ext => {
